...
int CPuzzle8::Heuristica(void)
{
	...
	// distancia de manhatan de cada posicao a sua possicao final
	for(int i=1;i<9;i++) {
		int posicaoI=0;
...
{
	// se quiser saber o que seria a procura se nao se impedir ciclos,
	// simplesmente retorne sempre true e comente o restante codigo

	// para nao produzir ciclos:
	CPuzzle8 *aux=(CPuzzle8*)estado;  // JM
	return (*this)!=(*aux);           //JM
	//return true;  //JM
}
